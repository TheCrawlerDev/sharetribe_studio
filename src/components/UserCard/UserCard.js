...
// import { VerifiedIconLogo } from '../../containers/AuthenticationPage/socialLoginLogos';
  ...
  return (
    <div className={classes}>
      <div className={css.content}>
        ...
        {/* {publicData?.verified == true ? <span className={css.verifiedIcon}>{VerifiedIconLogo}</span> : <></>} */}
