...
export const YoutubeEmbed = props => {
  ...
  let videoMain = 'gDrbphXUof4';

  return (
    <AspectRatioWrapper className={classes} width={width} height={height}>
      <LazyIFrame
        // src={videoMain == youtubeVideoId ? `https://www.youtube.com/embed/${youtubeVideoId}?autoplay=1` : `https://www.youtube-nocookie.com/embed/${youtubeVideoId}`}
