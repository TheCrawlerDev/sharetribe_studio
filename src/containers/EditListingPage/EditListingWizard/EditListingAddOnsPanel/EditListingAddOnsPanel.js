...
import EditListingAddOnsForm from './EditListingAddOnsForm';
import css from './EditListingAddOnsPanel.module.css';
 ...
 *
 * In the latter case, we select first type in the array. However, EditListingAddOnsForm component
...
const EditListingAddOnsPanel = props => {
  ...
  const canShowEditListingAddOnsForm =
    ...
    <div className={classes}>
      <H3 as="h1">
        {isPublished ? (
          ...
          <FormattedMessage
            id="EditListingAddOnsPanel.createListingTitle"
            values={{ lineBreak: <br /> }}
          />
        )}
      </H3>

      {canShowEditListingAddOnsForm ? (
        <EditListingAddOnsForm
          className={css.form}
